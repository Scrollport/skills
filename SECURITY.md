...
[GitHub private vulnerability reporting](https://github.com/Scrollport/scrollport-control-skill/security/advisories/new)
...
GitHub secret scanning is a backstop, not permission to include sensitive
evidence.
